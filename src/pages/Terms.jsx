...
export default function Terms() {
  return (
    <LegalShell title="Terms of Service" updated="July 2026">
      <H2>1. Acceptance</H2>
      <p>By creating an account or using RecompIQ, you agree to these Terms. If you don't agree, don't use the app.</p>

      <H2>2. Eligibility</H2>
      <p>You must be at least 18 years old and able to enter into a binding agreement to use RecompIQ.</p>
      ...
      <H2>7. Disclaimers</H2>
      <p className="text-muted-foreground">RecompIQ is provided "as is" without warranties of any kind. Plans and recommendations are estimates and may not produce specific results.</p>

      <H2>8. Limitation of liability</H2>
      <p>To the maximum extent permitted by law, RecompIQ and its providers are not liable for any indirect, incidental, or consequential damages arising from your use of the app.</p>
