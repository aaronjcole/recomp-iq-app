...
Adaptive nutrition and training guidance built around your real progress.
...
- A focused Today screen with one recommended next move
- Adaptive calorie, macro, activity, and training targets
- Fast logging for weight, nutrition, steps, sleep, mood, habits, and workouts
- Weekly check-ins that explain whether to hold steady or adjust
- Progress trends and projections with visible confidence and supporting context
- Strength-session history and progression insights
...
- Support email: `recompappsupport@gmail.com`
- Website: `https://recomp-iq.base44.app`
...
prepared action that has not been tested in the installed build.
